...
#import "PangaltiViewController.h"

@interface PangaltiViewController ()

@end

@implementation PangaltiViewController
...
-(void) updateDolapdere{
    ...
    if ([today isEqualToString:Saturday]){
        [self updateClock: [NSArray arrayWithObjects:[NSNumber numberWithInt:9],[NSNumber numberWithInt:13], [NSNumber numberWithInt:14],nil]: [NSArray arrayWithObjects:[NSNumber numberWithInt:45],[NSNumber numberWithInt:30],[NSNumber numberWithInt:15], nil]:pangaltiDolapdere];
    }
    else if([today isEqualToString:Sunday]){
    
        [pangaltiDolapdere setText:@"No Bus"];
    }
    else{
    [self updateClock: [NSArray arrayWithObjects:[NSNumber numberWithInt:8],[NSNumber numberWithInt:8], [NSNumber numberWithInt:8],[NSNumber numberWithInt:9],[NSNumber numberWithInt:9],[NSNumber numberWithInt:10],[NSNumber numberWithInt:10],[NSNumber numberWithInt:11],[NSNumber numberWithInt:11],[NSNumber numberWithInt:12],[NSNumber numberWithInt:12],[NSNumber numberWithInt:13],[NSNumber numberWithInt:13],[NSNumber numberWithInt:14],[NSNumber numberWithInt:14],[NSNumber numberWithInt:15],[NSNumber numberWithInt:15],[NSNumber numberWithInt:16],[NSNumber numberWithInt:16],[NSNumber numberWithInt:17],[NSNumber numberWithInt:17],[NSNumber numberWithInt:18],nil]: [NSArray arrayWithObjects:[NSNumber numberWithInt:15],[NSNumber numberWithInt:30],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15],[NSNumber numberWithInt:45],[NSNumber numberWithInt:15], nil]:pangaltiDolapdere];
    }
...
- (void)viewDidLoad
{
	...
	timerc= [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(updateDolapdere) userInfo:nil repeats:YES];}
